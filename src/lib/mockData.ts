...
export const mockModels: Model[] = [
  ...
  { id: 'model-6', name: 'Housing Concrete As-Built (Revit)', updated_at: '2025-01-18T09:15:00Z' },
  { id: 'model-7', name: 'Housing Concrete Building Permit', updated_at: '2025-01-18T09:20:00Z' },
  { id: 'model-8', name: 'Housing Timber As-Built (Archicad)', updated_at: '2025-01-18T09:25:00Z' },
  { id: 'model-9', name: 'Housing Timber As-Built (Revit)', updated_at: '2025-01-18T09:30:00Z' },
  { id: 'model-10', name: 'Housing Timber Building Permit', updated_at: '2025-01-18T09:35:00Z' },
  { id: 'model-11', name: 'Office Concrete As-Built (Revit)', updated_at: '2025-01-18T09:40:00Z' },
  { id: 'model-12', name: 'Office Concrete Permit (Archicad)', updated_at: '2025-01-18T09:45:00Z' },
  { id: 'model-13', name: 'Office Concrete Building Permit', updated_at: '2025-01-18T09:50:00Z' },
  { id: 'model-14', name: 'Office Timber As-Built (Revit)', updated_at: '2025-01-18T09:55:00Z' },
  { id: 'model-15', name: 'Office Timber Building Permit', updated_at: '2025-01-18T10:00:00Z' },
];
...
export const mockElementsByModel: Record<string, Element[]> = {
  ...
  'model-6': [ // Housing Concrete As-Built
    { id: 7001, label: 'Foundation Wall A', type: 'COLUMN' },
    { id: 7002, label: 'Foundation Wall B', type: 'COLUMN' },
    { id: 7003, label: 'Foundation Wall C', type: 'COLUMN' },
    { id: 7004, label: 'Foundation Wall D', type: 'COLUMN' },
    { id: 7101, label: 'Load Bearing Wall 1A', type: 'COLUMN' },
    { id: 7102, label: 'Load Bearing Wall 1B', type: 'COLUMN' },
    { id: 7103, label: 'Load Bearing Wall 1C', type: 'COLUMN' },
    { id: 7104, label: 'Load Bearing Wall 2A', type: 'COLUMN' },
    { id: 7105, label: 'Load Bearing Wall 2B', type: 'COLUMN' },
    { id: 7106, label: 'Load Bearing Wall 2C', type: 'COLUMN' },
    { id: 7201, label: 'Floor Slab Level 1', type: 'BEAM' },
    { id: 7202, label: 'Floor Slab Level 2', type: 'BEAM' },
    { id: 7203, label: 'Floor Slab Level 3', type: 'BEAM' },
    { id: 7204, label: 'Roof Slab', type: 'BEAM' },
    { id: 7301, label: 'Balcony Slab Unit A', type: 'BEAM' },
    { id: 7302, label: 'Balcony Slab Unit B', type: 'BEAM' },
  ],
  'model-7': [ // Housing Concrete Building Permit
    { id: 7401, label: 'Foundation Footing A', type: 'COLUMN' },
    { id: 7402, label: 'Foundation Footing B', type: 'COLUMN' },
    { id: 7403, label: 'Foundation Footing C', type: 'COLUMN' },
    { id: 7501, label: 'Shear Wall SW-1', type: 'COLUMN' },
    { id: 7502, label: 'Shear Wall SW-2', type: 'COLUMN' },
    { id: 7503, label: 'Shear Wall SW-3', type: 'COLUMN' },
    { id: 7601, label: 'Concrete Beam CB-1', type: 'BEAM' },
    { id: 7602, label: 'Concrete Beam CB-2', type: 'BEAM' },
    { id: 7603, label: 'Concrete Beam CB-3', type: 'BEAM' },
  ],
  'model-8': [ // Housing Timber As-Built Archicad
    { id: 7701, label: 'Timber Column TC-1A', type: 'COLUMN' },
    { id: 7702, label: 'Timber Column TC-1B', type: 'COLUMN' },
    { id: 7703, label: 'Timber Column TC-2A', type: 'COLUMN' },
    { id: 7704, label: 'Timber Column TC-2B', type: 'COLUMN' },
    { id: 7801, label: 'CLT Wall Panel W-1', type: 'COLUMN' },
    { id: 7802, label: 'CLT Wall Panel W-2', type: 'COLUMN' },
    { id: 7803, label: 'CLT Wall Panel W-3', type: 'COLUMN' },
    { id: 7901, label: 'CLT Floor F1', type: 'BEAM' },
    { id: 7902, label: 'CLT Floor F2', type: 'BEAM' },
    { id: 7903, label: 'CLT Floor F3', type: 'BEAM' },
    { id: 8001, label: 'Glulam Beam GB-1', type: 'BEAM' },
    { id: 8002, label: 'Glulam Beam GB-2', type: 'BEAM' },
  ],
  'model-9': [ // Housing Timber As-Built Revit
    { id: 8101, label: 'Timber Frame F1-A', type: 'COLUMN' },
    { id: 8102, label: 'Timber Frame F1-B', type: 'COLUMN' },
    { id: 8103, label: 'Timber Frame F2-A', type: 'COLUMN' },
    { id: 8104, label: 'Timber Frame F2-B', type: 'COLUMN' },
    { id: 8201, label: 'LVL Beam LB-1', type: 'BEAM' },
    { id: 8202, label: 'LVL Beam LB-2', type: 'BEAM' },
    { id: 8203, label: 'LVL Beam LB-3', type: 'BEAM' },
    { id: 8301, label: 'Roof Truss RT-1', type: 'TRUSS' },
    { id: 8302, label: 'Roof Truss RT-2', type: 'TRUSS' },
    { id: 8303, label: 'Roof Truss RT-3', type: 'TRUSS' },
  ],
  'model-10': [ // Housing Timber Building Permit
    { id: 8401, label: 'Stud Wall SW-1', type: 'COLUMN' },
    { id: 8402, label: 'Stud Wall SW-2', type: 'COLUMN' },
    { id: 8403, label: 'Stud Wall SW-3', type: 'COLUMN' },
    { id: 8501, label: 'Floor Joist FJ-1', type: 'BEAM' },
    { id: 8502, label: 'Floor Joist FJ-2', type: 'BEAM' },
    { id: 8503, label: 'Floor Joist FJ-3', type: 'BEAM' },
  ],
  'model-11': [ // Office Concrete As-Built Revit
    { id: 8601, label: 'Core Wall CW-1', type: 'COLUMN' },
    { id: 8602, label: 'Core Wall CW-2', type: 'COLUMN' },
    { id: 8603, label: 'Perimeter Column PC-1', type: 'COLUMN' },
    { id: 8604, label: 'Perimeter Column PC-2', type: 'COLUMN' },
    { id: 8605, label: 'Perimeter Column PC-3', type: 'COLUMN' },
    { id: 8606, label: 'Perimeter Column PC-4', type: 'COLUMN' },
    { id: 8701, label: 'Transfer Beam TB-1', type: 'BEAM' },
    { id: 8702, label: 'Transfer Beam TB-2', type: 'BEAM' },
    { id: 8703, label: 'Office Floor Slab L1', type: 'BEAM' },
    { id: 8704, label: 'Office Floor Slab L2', type: 'BEAM' },
    { id: 8705, label: 'Office Floor Slab L3', type: 'BEAM' },
  ],
  'model-12': [ // Office Concrete Permit Archicad
    { id: 8801, label: 'Foundation Pile FP-1', type: 'COLUMN' },
    { id: 8802, label: 'Foundation Pile FP-2', type: 'COLUMN' },
    { id: 8803, label: 'Foundation Pile FP-3', type: 'COLUMN' },
    { id: 8901, label: 'Grade Beam GB-1', type: 'BEAM' },
    { id: 8902, label: 'Grade Beam GB-2', type: 'BEAM' },
    { id: 8903, label: 'Parking Slab PS-1', type: 'BEAM' },
  ],
  'model-13': [ // Office Concrete Building Permit
    { id: 9001, label: 'Elevator Shaft ES-1', type: 'COLUMN' },
    { id: 9002, label: 'Stair Core SC-1', type: 'COLUMN' },
    { id: 9003, label: 'Structural Column C-1', type: 'COLUMN' },
    { id: 9004, label: 'Structural Column C-2', type: 'COLUMN' },
    { id: 9101, label: 'Spandrel Beam SB-1', type: 'BEAM' },
    { id: 9102, label: 'Spandrel Beam SB-2', type: 'BEAM' },
  ],
  'model-14': [ // Office Timber As-Built Revit
    { id: 9201, label: 'Glulam Column GC-1', type: 'COLUMN' },
    { id: 9202, label: 'Glulam Column GC-2', type: 'COLUMN' },
    { id: 9203, label: 'Glulam Column GC-3', type: 'COLUMN' },
    { id: 9301, label: 'CLT Panel Office F1', type: 'BEAM' },
    { id: 9302, label: 'CLT Panel Office F2', type: 'BEAM' },
    { id: 9303, label: 'CLT Panel Office F3', type: 'BEAM' },
    { id: 9401, label: 'Timber Truss TT-1', type: 'TRUSS' },
    { id: 9402, label: 'Timber Truss TT-2', type: 'TRUSS' },
  ],
  'model-15': [ // Office Timber Building Permit
    { id: 9501, label: 'Post PT-1', type: 'COLUMN' },
    { id: 9502, label: 'Post PT-2', type: 'COLUMN' },
    { id: 9503, label: 'Post PT-3', type: 'COLUMN' },
    { id: 9601, label: 'Beam Assembly BA-1', type: 'BEAM' },
    { id: 9602, label: 'Beam Assembly BA-2', type: 'BEAM' },
    { id: 9701, label: 'Lateral Brace LB-1', type: 'TRUSS' },
    { id: 9702, label: 'Lateral Brace LB-2', type: 'TRUSS' },
  ],
};
...
export const mockAnalysisResultsByModel: Record<string, AnalysisResult> = {
  ...
  'model-6': {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 7001, util: 0.82 }, { element_id: 7002, util: 0.79 }, { element_id: 7003, util: 0.84 }, { element_id: 7004, util: 0.81 },
      { element_id: 7101, util: 0.75 }, { element_id: 7102, util: 0.78 }, { element_id: 7103, util: 0.72 },
      { element_id: 7104, util: 0.69 }, { element_id: 7105, util: 0.73 }, { element_id: 7106, util: 0.71 },
      { element_id: 7201, util: 0.86 }, { element_id: 7202, util: 0.89 }, { element_id: 7203, util: 0.83 }, { element_id: 7204, util: 0.67 },
      { element_id: 7301, util: 0.64 }, { element_id: 7302, util: 0.66 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/housing-concrete-asbuilt.pdf',
  },
  'model-7': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 7401, util: 0.71 }, { element_id: 7402, util: 0.68 }, { element_id: 7403, util: 0.73 },
      { element_id: 7501, util: 0.77 }, { element_id: 7502, util: 0.74 }, { element_id: 7503, util: 0.72 },
      { element_id: 7601, util: 0.65 }, { element_id: 7602, util: 0.69 }, { element_id: 7603, util: 0.67 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/housing-concrete-permit.pdf',
  },
  'model-8': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 7701, util: 0.68 }, { element_id: 7702, util: 0.71 }, { element_id: 7703, util: 0.66 }, { element_id: 7704, util: 0.69 },
      { element_id: 7801, util: 0.63 }, { element_id: 7802, util: 0.67 }, { element_id: 7803, util: 0.64 },
      { element_id: 7901, util: 0.70 }, { element_id: 7902, util: 0.73 }, { element_id: 7903, util: 0.59 },
      { element_id: 8001, util: 0.62 }, { element_id: 8002, util: 0.65 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/housing-timber-archicad.pdf',
  },
  'model-9': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 8101, util: 0.69 }, { element_id: 8102, util: 0.72 }, { element_id: 8103, util: 0.67 }, { element_id: 8104, util: 0.70 },
      { element_id: 8201, util: 0.74 }, { element_id: 8202, util: 0.76 }, { element_id: 8203, util: 0.71 },
      { element_id: 8301, util: 0.58 }, { element_id: 8302, util: 0.61 }, { element_id: 8303, util: 0.56 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/housing-timber-revit.pdf',
  },
  'model-10': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 8401, util: 0.62 }, { element_id: 8402, util: 0.65 }, { element_id: 8403, util: 0.60 },
      { element_id: 8501, util: 0.66 }, { element_id: 8502, util: 0.68 }, { element_id: 8503, util: 0.64 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/housing-timber-permit.pdf',
  },
  'model-11': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 8601, util: 0.87 }, { element_id: 8602, util: 0.84 },
      { element_id: 8603, util: 0.78 }, { element_id: 8604, util: 0.81 }, { element_id: 8605, util: 0.76 }, { element_id: 8606, util: 0.79 },
      { element_id: 8701, util: 0.89 }, { element_id: 8702, util: 0.91 },
      { element_id: 8703, util: 0.82 }, { element_id: 8704, util: 0.85 }, { element_id: 8705, util: 0.74 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/office-concrete-revit.pdf',
  },
  'model-12': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 8801, util: 0.75 }, { element_id: 8802, util: 0.78 }, { element_id: 8803, util: 0.73 },
      { element_id: 8901, util: 0.80 }, { element_id: 8902, util: 0.77 }, { element_id: 8903, util: 0.72 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/office-concrete-archicad.pdf',
  },
  'model-13': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 9001, util: 0.81 }, { element_id: 9002, util: 0.79 },
      { element_id: 9003, util: 0.76 }, { element_id: 9004, util: 0.78 },
      { element_id: 9101, util: 0.82 }, { element_id: 9102, util: 0.84 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/office-concrete-permit.pdf',
  },
  'model-14': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 9201, util: 0.72 }, { element_id: 9202, util: 0.75 }, { element_id: 9203, util: 0.70 },
      { element_id: 9301, util: 0.77 }, { element_id: 9302, util: 0.79 }, { element_id: 9303, util: 0.68 },
      { element_id: 9401, util: 0.61 }, { element_id: 9402, util: 0.64 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/office-timber-revit.pdf',
  },
  'model-15': {
    status: 'succeeded',
    summary: {
    ...
    exceedances: [],
    heatmap: [
      { element_id: 9501, util: 0.65 }, { element_id: 9502, util: 0.68 }, { element_id: 9503, util: 0.63 },
      { element_id: 9601, util: 0.69 }, { element_id: 9602, util: 0.71 },
      { element_id: 9701, util: 0.58 }, { element_id: 9702, util: 0.60 },
    ],
    report_url: 'https://rfem-backend.example.com/reports/office-timber-permit.pdf',
  },
};
